    ...
    switch(opt){
        case 1: 
                if(strcmp(hotel.roomType,"Single")==0){
                 ...
                 main();
                 break;
        case 2:  fclose(enter);system("cls");addReservation();break;
        case 3:  fclose(enter);system("cls");main();break;
        default: fclose(enter);printf("\n\t Invalid Option! Please enter a valid option number.\n\n\n");
                 main();
                 break;
    }
	...
	char roomID[5];
        ...
        case 1: 
		   ...
		   main();
	         ...
	         main();
                 break;
        case 2:  fclose(enter);fclose(tmp);system("cls");deleteReservation();break;
        case 3:  fclose(enter);fclose(tmp);system("cls");main();break;
        default: fclose(enter);fclose(tmp);printf("\n\t Invalid Option! Please enter a valid option number.\n\n\n");
                 main();
                 break;
    }
...
void viewReservationDetails()
{
    ...
    scanf("%d", &opt);
       switch(opt){
          case 1:  fclose(enter);system("cls");main();break;
          default: fclose(enter);printf("\n\t Invalid Option! Please enter a valid option number.\n");
                   viewReservationDetails();
                   break;
       }
